...
/** Generated Interface for C_BankDeposit
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS
 */
public interface I_C_BankDeposit 
{

    /** TableName=C_BankDeposit */
    public static final String Table_Name = "C_BankDeposit";
    ...
    public static final String COLUMNNAME_DepositDate = "DepositDate";

	/** Set Deposit Date.
	  * Date of the deposit was made
	  */
    ...
    public static final String COLUMNNAME_TotalDeposit = "TotalDeposit";

	/** Set Total Deposit.
	  * The total of all the deposit items in the bank account currency.
	  */
