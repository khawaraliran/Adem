...
/** Generated Model for C_BankDeposit
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_C_BankDeposit extends PO implements I_C_BankDeposit, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_C_BankDeposit (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_BankDeposit[")
	...
	{
		set_Value (COLUMNNAME_DepositDate, DepositDate);
	}

	/** Get Deposit Date.
		@return Date of the deposit was made
	  */
	public Timestamp getDepositDate () 
	{
		return (Timestamp)get_Value(COLUMNNAME_DepositDate);
	}
	...
	{
		throw new IllegalArgumentException ("IsReconciled is virtual column");	}
	...
	{
		set_Value (COLUMNNAME_TotalDeposit, TotalDeposit);
	}

	/** Get Total Deposit.
		@return The total of all the deposit items in the bank account currency.
	  */
	public BigDecimal getTotalDeposit () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_TotalDeposit);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
