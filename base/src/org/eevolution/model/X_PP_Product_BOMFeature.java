...
/** Generated Model for PP_Product_BOMFeature
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_PP_Product_BOMFeature extends PO implements I_PP_Product_BOMFeature, I_Persistent 
{
    ...
    public X_PP_Product_BOMFeature (Properties ctx, int PP_Product_BOMFeature_ID, String trxName)
    {
      super (ctx, PP_Product_BOMFeature_ID, trxName);
      /** if (PP_Product_BOMFeature_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_PP_Product_BOMFeature (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PP_Product_BOMFeature[")
	...
	public void setPP_Product_BOMFeature_ID (int PP_Product_BOMFeature_ID)
	{
		if (PP_Product_BOMFeature_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_PP_Product_BOMFeature_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_PP_Product_BOMFeature_ID, Integer.valueOf(PP_Product_BOMFeature_ID));
	}
