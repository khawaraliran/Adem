...
public class ModelValidatorException extends AdempiereException
{
	...
	public ModelValidatorException(final String message, final boolean passOn)
	{
		super(message);
		this.passOn = passOn;
	}

	public ModelValidatorException(final String message, final Throwable cause, final boolean passOn)
	{
		super(message, cause);
		this.passOn = passOn;
	}
	...
	/**
	 * Method is called by the fire* methods of {@link ModelValidationEngine}. 
	 * @return
	 */
