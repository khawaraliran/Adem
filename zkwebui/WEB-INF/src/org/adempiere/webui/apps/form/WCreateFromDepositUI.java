...
public class WCreateFromDepositUI extends CreateFromDeposit implements EventListener
{
	...
	private Label creditCardTypeLabel = new Label();
	protected WTableDirEditor creditCardTypeField;
	...
	protected void zkInit() throws Exception
	{
    	...
    	creditCardTypeLabel.setText(Msg.translate(Env.getCtx(), "CreditCardType"));
		...
		row.appendChild(creditCardTypeLabel.rightAlign());
		row.appendChild(creditCardTypeField.getComponent());
