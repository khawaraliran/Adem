...
/** Generated Model for HR_Emp_Gate_Attendence
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id: X_HR_Emp_Gate_Attendence.java 1009 2012-02-09 09:16:13Z suman $ */
public class X_HR_Emp_Gate_Attendence extends PO implements I_HR_Emp_Gate_Attendence, I_Persistent 
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: X_HR_Emp_Gate_Attendence.java 1009 2012-02-09 09:16:13Z suman $";
    ...
    public X_HR_Emp_Gate_Attendence (Properties ctx, int HR_Emp_Gate_Attendence_ID, String trxName)
    {
      super (ctx, HR_Emp_Gate_Attendence_ID, trxName);
      /** if (HR_Emp_Gate_Attendence_ID == 0)
        {
			setC_BPartner_ID (0);
			setHR_Emp_Gate_Attendence_ID (0);
			setincomingtime (new Timestamp( System.currentTimeMillis() ));
			setislatecoming (false);
			setloginpunch (null);
			setlogoutpunch (null);
			setProcessed (false);
...
// @#Date@
    ...
    /** Load Constructor */
    public X_HR_Emp_Gate_Attendence (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_Emp_Gate_Attendence[")
	...
	/** Set HR_Emp_Gate_Attendence.
		@param HR_Emp_Gate_Attendence_ID HR_Emp_Gate_Attendence	  */
	public void setHR_Emp_Gate_Attendence_ID (int HR_Emp_Gate_Attendence_ID)
	{
		if (HR_Emp_Gate_Attendence_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HR_Emp_Gate_Attendence_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_Emp_Gate_Attendence_ID, Integer.valueOf(HR_Emp_Gate_Attendence_ID));
	}

	/** Get HR_Emp_Gate_Attendence.
		@return HR_Emp_Gate_Attendence	  */
	public int getHR_Emp_Gate_Attendence_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_HR_Emp_Gate_Attendence_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set islatecoming.
		@param islatecoming islatecoming	  */
	public void setislatecoming (boolean islatecoming)
	{
		set_Value (COLUMNNAME_islatecoming, Boolean.valueOf(islatecoming));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_islatecoming);
		if (oo != null) 
		{
	...
	/** Set loginpunch.
		@param loginpunch loginpunch	  */
	public void setloginpunch (String loginpunch)
	{
		set_Value (COLUMNNAME_loginpunch, loginpunch);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_loginpunch);
	}

	/** Set logoutpunch.
		@param logoutpunch logoutpunch	  */
	public void setlogoutpunch (String logoutpunch)
	{
		set_Value (COLUMNNAME_logoutpunch, logoutpunch);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_logoutpunch);
	}
