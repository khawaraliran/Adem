 ...
 *  @version $Id: MRequisition.java 1009 2012-02-09 09:16:13Z suman $
 *  @author red1
 ...
 *  PhaniKiran.Gutha	20120301556		 1673			Material Costing Enhancements
 */
public class MRequisition extends X_M_Requisition implements DocAction
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: MRequisition.java 1009 2012-02-09 09:16:13Z suman $";
	/**
	 * 
	 */
	...
	public MRequisition (Properties ctx, ResultSet rs, String trxName)
	{
	  ...
	  /**
	   * 20120301556
	   * copy the indent details to the requisition
	   * @param indent
	   */
	 public MRequisition (MInventory indent) 
	 { 
	  this (indent.getCtx(), 0, indent.get_TrxName()); 
	  this.setDateRequired(indent.getMovementDate()); 
	  this.setC_BPartner_ID( indent.getC_BPartner_ID() );
	  this.setDateRequired( indent.getRequestDate() );
	  this.setClientOrg(indent);
	  this.setHR_Department_ID( indent.getHR_Department_ID() );
	  this.setM_Warehouse_ID( indent.getM_Warehouse_ID() );
	  this.setDescription( indent.getDescription() );
	 } // MRequisition 
