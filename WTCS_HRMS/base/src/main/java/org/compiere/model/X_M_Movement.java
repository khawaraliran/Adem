 ...
 *  @version Release 3.6.0LTS - $Id: X_M_Movement.java 1009 2012-02-09 09:16:13Z suman $ */
public class X_M_Movement extends PO implements I_M_Movement, I_Persistent 
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: X_M_Movement.java 1009 2012-02-09 09:16:13Z suman $";
...
// @#Date@
	...
	/** Set Is Source Approved ?.
		@param IsSourceApproved 
		Is Source Approved ?
	  */
	public void setIsSourceApproved (boolean IsSourceApproved)
	{
		set_Value (COLUMNNAME_IsSourceApproved, Boolean.valueOf(IsSourceApproved));
	}

	/** Get Is Source Approved ?.
		@return Is Source Approved ?
	  */
	public boolean isSourceApproved () 
	{
		Object oo = get_Value(COLUMNNAME_IsSourceApproved);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public I_M_Warehouse getM_Warehouse_To() throws RuntimeException
    {
		return (I_M_Warehouse)MTable.get(getCtx(), I_M_Warehouse.Table_Name)
			.getPO(getM_Warehouse_To_ID(), get_TrxName());	}

	/** Set To Warehouse.
		@param M_Warehouse_To_ID 
		To Warehouse
	  */
