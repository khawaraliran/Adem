...
/** Generated Interface for HR_SalaryChange
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS
 */
public interface I_HR_SalaryChange 
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: I_HR_SalaryChange.java 1009 2012-02-09 09:16:13Z suman $";

    /** TableName=HR_SalaryChange */
    public static final String Table_Name = "HR_SalaryChange";
    ...
    /** Column name arrierscalculated */
    public static final String COLUMNNAME_arrierscalculated = "arrierscalculated";
    ...
    /** Column name HR_SalaryChange_ID */
    public static final String COLUMNNAME_HR_SalaryChange_ID = "HR_SalaryChange_ID";
    ...
    /** Column name newdailywage */
    public static final String COLUMNNAME_newdailywage = "newdailywage";
    ...
    /** Column name olddailywage */
    public static final String COLUMNNAME_olddailywage = "olddailywage";
    ...
    public static final String COLUMNNAME_oldsalary = "oldsalary";
    ...
    /** Column name salaryupdated */
    public static final String COLUMNNAME_salaryupdated = "salaryupdated";
