 ...
 *  @version  $Id: GridFieldVO.java 1906 2013-06-25 18:44:36Z vinod.kakumani $
 *  
 *   *  @author Jorg Janke
 *  @version  $Id: GridFieldVO.java 1906 2013-06-25 18:44:36Z vinod.kakumani $
 *  
 ...
 * K.Vinod              [20130625]       20040   	 Introduced new variable isRange and added new method isRange()  (AD_Column) 
 *******************************************************************************************************************************************************************
 */
public class GridFieldVO implements Serializable
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: GridFieldVO.java 1906 2013-06-25 18:44:36Z vinod.kakumani $";

	/**
	 * @author Giri 
	 * <BR>
	 * @ChaneId [20120106]
	 * <li> Here we are checking with isCustom 
	 * <li> If it is a customized window then return custom sql (query to AD_UserDef_Field_v View )
	 * 
	 *  Return the SQL statement used for the MFieldVO.create
	 *  @param ctx context
	 *  @return SQL with or w/o translation and 1 parameter
	 */
	public static String getSQL (Properties ctx, boolean isCustom)
	{
		String sql ="";
		if( isCustom ) {
			sql = "SELECT * FROM AD_UserDef_Field_v WHERE AD_UserDef_Tab_ID = ? ORDER BY IsDisplayed DESC, SeqNo";
		}
		else {
		//	IsActive is part of View
			sql = "SELECT * FROM AD_Field_v WHERE AD_Tab_ID=?"
		...
		int AD_Window_ID, int AD_Tab_ID, boolean readOnly, ResultSet rs)
	{
		...
		try
		{
			...
			for (int i = 1; i <= rsmd.getColumnCount(); i++)
			{
				...
				else if (columnName.equalsIgnoreCase("IsRange"))  					//20040
...
//				Feature Request FR [ 2003044 ]
	...
	/**	Find isRange		*/
	public boolean		IsRange = false;				//20040
	/**	Order By		*/
	public int          SortNo = 0;
	/**	Field Length		*/
