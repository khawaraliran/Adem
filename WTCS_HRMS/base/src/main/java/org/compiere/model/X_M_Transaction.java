 ...
 *  @version Release 3.6.0LTS - $Id: X_M_Transaction.java 1009 2012-02-09 09:16:13Z suman $ */
public class X_M_Transaction extends PO implements I_M_Transaction, I_Persistent 
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: X_M_Transaction.java 1009 2012-02-09 09:16:13Z suman $";

	/**
	 *
	 */
	private static final long serialVersionUID = 20111213L;
	...
	/** Service Sent = S- */
	public static final String MOVEMENTTYPE_ServiceSent = "S-";
	/** Service Return = S+ */
	public static final String MOVEMENTTYPE_ServiceReturn = "S+";
	/** Set Movement Type.
		@param MovementType 
	...
	/** Set Service Request Line.
		@param WTC_Service_Request_Line_ID Service Request Line	  */
	public void setWTC_Service_Request_Line_ID (int WTC_Service_Request_Line_ID)
	{
		if (WTC_Service_Request_Line_ID < 1) 
			set_Value (COLUMNNAME_WTC_Service_Request_Line_ID, null);
		else 
			set_Value (COLUMNNAME_WTC_Service_Request_Line_ID, Integer.valueOf(WTC_Service_Request_Line_ID));
	}

	/** Get Service Request Line.
		@return Service Request Line	  */
	public int getWTC_Service_Request_Line_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_WTC_Service_Request_Line_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
