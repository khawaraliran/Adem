 ...
 *<pre>
 *	Bug 	@Identification		@author						@Change
 *------------------------------------------------------------------------------------------------------------------------------
 *	2343 	201203090945		Yadagiri Rao.Dontineni		Min Max Validation Related code removed 	 
 *	
 *</pre>																	
 */
public class POInfo implements Serializable
{
	...
	public String validate (int index, Object value)
	{
		...
		//	201203090945
		//	Min max validation Related code removed & it is not required here 
		// Reason of removed :- Not Implementation doesn't cover all the scenario's 
		return null;
	}   //  validate
