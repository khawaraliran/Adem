 ...
 *  </pre>
 *  @author 	Jorg Janke
 *  @version 	$Id: GridTab.java 1058 2012-02-22 11:27:42Z ranjit $
 *  
 ...
 * 											      That Records Are Not Deleted to the System
 * 
 * Giri			[20120111]			1722		  Introduced 2 getter methods, as part of Window customization issue 
 * 
 * Arunkumar    [20120124:5:00PM]   1697   		 Modified: getMTable() :   For Checking mandatory functionality we need to have m_MTable Object in 
 * 													       AbstractADWindowPanel.java=> setActiveTab(int) 
 * 											               So Modified access modifier to give access to out of package class
 * Arunkumar    [20120127:8:30PM]   1697         Modified: getMTable() :   As we have getTableModel()  to do the Work , we are reverting the changes.
 * 
 * Arunkumar    [20120221:6:00PM]   2068         Modified: processCallout(GridField)
 *                                                         if the field that is passed is not there (Null) then we are returning without validating callout.
 *                                                         
 *				201202220244		2150		Chat functionality                                                         
 ******************************************************************************************/
public class GridTab implements DataStatusListener, Evaluatee, Serializable
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: GridTab.java 1058 2012-02-22 11:27:42Z ranjit $";
	/**
	 * 
	 */
	...
	public boolean dataNew (boolean copy)
	{
		...
		{
			boolean processed = "Y".equals(Env.getContext(m_vo.ctx, m_vo.WindowNo, m_vo.TabNo,  "Processed"));
	...
	public boolean dataDelete()
	{
		//[20111213]
		log.fine("#" + m_vo.TabNo + " - row=" + m_currentRow);
		String isSystemGen=Env.getContext(m_vo.ctx, m_vo.WindowNo,m_vo.TabNo, "IsSystemGenerated", true, true);
    	if(isSystemGen != null)
    	{
			boolean isSystemGenerated ="Y".equalsIgnoreCase(isSystemGen);
			if(isSystemGenerated)
			{
				log.warning ("Not allowed in TabNo=" + m_vo.TabNo + " -> IsSystemGenerated=" + isSystemGenerated);
				String msg=Msg.getMsg(m_vo.ctx, " Can't Delete The Record ,As It is Created By System ");
				this.fireDataStatusEEvent(msg, "", true);
				return false;
			}
		}
	...
	/**
	 *  Bug-1697 [20120124:5:00PM] ,  [20120127:8:30PM]
	 *  For Checking mandatory functionality we need to have m_MTable Object To AbstractADWindowPanel.java
	 *  So Modified access modifier to give access to out of package class
	 *	Return Table Model
	 *  @return MTable
	 */
	...
	//
	// [Change Id - 201202220244]
	// Tells whether for tab chat button is enable or disable
	//
	
	public boolean canHaveChat(){
		return m_vo.enableChat;
	}
	 ...
	 * @ChangeId 20120111
	 * 
	 * @return AD_UserDefTab ID 
	 */
	public int getAD_UserDefTab_ID() {
		
		return m_vo.AD_UserDef_Tab_ID;
	}
...
//					value = mField.getDefault();
	 ...
	 *  
	 *  
	 * @return True if it is a customized window
	 */
	public boolean getIsCustomWindow() {

		return m_vo.isCustomizationWindow ;
	}
}	//	GridTab
