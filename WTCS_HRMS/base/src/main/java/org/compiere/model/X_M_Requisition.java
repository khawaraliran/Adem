 ...
 *  @version Release 3.6.0LTS - $Id: X_M_Requisition.java 1009 2012-02-09 09:16:13Z suman $ */
public class X_M_Requisition extends PO implements I_M_Requisition, I_Persistent 
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: X_M_Requisition.java 1009 2012-02-09 09:16:13Z suman $";
...
// 5
	...
	/** Set CreateQuotation.
		@param CreateQuotation CreateQuotation	  */
	public void setCreateQuotation (String CreateQuotation)
	{
		set_Value (COLUMNNAME_CreateQuotation, CreateQuotation);
	}

	/** Get CreateQuotation.
		@return CreateQuotation	  */
	public String getCreateQuotation () 
	{
		return (String)get_Value(COLUMNNAME_CreateQuotation);
	}
	...
	/** Set Purchase On Price List ?.
		@param IsPurchaseOnPriceList 
		Purchase On Price List ?
	  */
	public void setIsPurchaseOnPriceList (boolean IsPurchaseOnPriceList)
	{
		set_Value (COLUMNNAME_IsPurchaseOnPriceList, Boolean.valueOf(IsPurchaseOnPriceList));
	}

	/** Get Purchase On Price List ?.
		@return Purchase On Price List ?
	  */
	public boolean isPurchaseOnPriceList () 
	{
		Object oo = get_Value(COLUMNNAME_IsPurchaseOnPriceList);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
