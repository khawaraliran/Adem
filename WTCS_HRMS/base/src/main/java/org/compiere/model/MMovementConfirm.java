 ...
 *  Anitha.k    2644         [20120326]    Added new message in completeIt() :                                                                                 *
...
public class MMovementConfirm extends X_M_MovementConfirm implements DocAction
{
	...
	public String completeIt()
	{
		...
		for (int i = 0; i < lines.length; i++)
		{
			...
			{
				String message = Msg.getMsg(Env.getCtx(),"MovementQty");//[20120326]
				m_processMsg = "ShipLine not saved - " + message;
				return DocAction.STATUS_Invalid;
			}
