 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MMovementLine.java 1174 2012-03-27 11:06:26Z anitha $
 * ************************************************************************************************************************************************************* 
 *  @author     @bugNo       @ChangeId    @Description                                                                                                         *
 *  Anitha.k    2644         [20120326]    Added to  new message in beforeSave(new record) :                                                                   *
 *                                         MovementQty Is Movement Qty Should Not Be Less Than Zero                                                            *
 *                                         When Doc Status Other Than Voided,InProgress,Approved,Not Approved,Invalid And Drafted                              *
 ***************************************************************************************************************************************************************/
public class MMovementLine extends X_M_MovementLine implements IDocumentLine
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: MMovementLine.java 1174 2012-03-27 11:06:26Z anitha $";
	/**
	 * 
	 */
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if (getMovementQty().signum() == 0)
		{
				...
				) 
			{
				...
				String message = Msg.getMsg(Env.getCtx(),"MovementQty");
				log.saveError( "MovementQty" , message );
				return false;
			}
		}
