 ...
 *  
 *<pre>
 *<li> @author             @IssueNo        @ChangeID			@Description
 *<li> D.Yadagiri Rao        4732         201206181509      LDAP feature is Enable then we are returning as null if ldap authentication fails 
 * </pre>
 */
public class Login
{
	...
	private KeyNamePair[] getRoles (String app_user, String app_pwd, boolean force)
	{
		...
		if (system.isLDAP())
		{
			...
			if (authenticated)	{
				...
				boolean value	=	MSysConfig.getBooleanValue( EagleMessageConstants.LDAP_BACKUP, Boolean.TRUE );
				if ( ! value	)	{
					return null;
				}
			}
