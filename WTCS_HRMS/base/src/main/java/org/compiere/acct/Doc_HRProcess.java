 ...
 *  @version  $Id: Doc_HRProcess.java 1009 2012-02-09 09:16:13Z suman $
 ...
 *  ----------------------------------------------------------------------------
 *  1883		09/01/2012		201201091124			Ranjit			If payroll process type is "Mock" / "Worksheet"
 *  																	then posting should not happen, in these cases we are returning
 *  																	the lines as empty.
 *  																			
 *  
 */
...
public static final String svnRevision =  "$Id: Doc_HRProcess.java 1009 2012-02-09 09:16:13Z suman $";
	...
	public ArrayList<Fact> createFacts (MAcctSchema as)
	{
		...
		//  201201091124 - [Change Identification]
		
		ArrayList<Fact> facts = new ArrayList<Fact>();
		
		String payrollProcessType = process.getpayrollprocesstype();
		
		if( null != payrollProcessType && 
			payrollProcessType.equalsIgnoreCase(X_HR_Process.PAYROLLPROCESSTYPE_Mock) ||
		    payrollProcessType.equalsIgnoreCase(X_HR_Process.PAYROLLPROCESSTYPE_Worksheet)) {
