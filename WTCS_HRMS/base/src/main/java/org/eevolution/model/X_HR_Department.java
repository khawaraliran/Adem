 ...
 *  @version Release 3.6.0LTS - $Id: X_HR_Department.java 1009 2012-02-09 09:16:13Z suman $ */
public class X_HR_Department extends PO implements I_HR_Department, I_Persistent 
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: X_HR_Department.java 1009 2012-02-09 09:16:13Z suman $";
	...
	/** Set stregthrequired.
		@param stregthrequired stregthrequired	  */
	public void setstregthrequired (int stregthrequired)
	{
		set_Value (COLUMNNAME_stregthrequired, Integer.valueOf(stregthrequired));
	}

	/** Get stregthrequired.
		@return stregthrequired	  */
	public int getstregthrequired () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_stregthrequired);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
