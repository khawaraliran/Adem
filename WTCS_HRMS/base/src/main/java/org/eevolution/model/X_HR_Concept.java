 ...
 *  @version Release 3.6.0LTS - $Id: X_HR_Concept.java 1009 2012-02-09 09:16:13Z suman $ */
public class X_HR_Concept extends PO implements I_HR_Concept, I_Persistent 
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: X_HR_Concept.java 1009 2012-02-09 09:16:13Z suman $";
	...
	/** Set printallways.
		@param printallways printallways	  */
	public void setprintallways (boolean printallways)
	{
		set_Value (COLUMNNAME_printallways, Boolean.valueOf(printallways));
	}

	/** Get printallways.
		@return printallways	  */
	public boolean isprintallways () 
	{
		Object oo = get_Value(COLUMNNAME_printallways);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
