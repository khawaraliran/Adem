 ...
 *  @version Release 3.6.0LTS - $Id: X_HR_Process.java 1009 2012-02-09 09:16:13Z suman $ */
public class X_HR_Process extends PO implements I_HR_Process, I_Persistent 
{
// Kindly do not delete below line as it is being used for svn version maintenance
public static final String svnRevision =  "$Id: X_HR_Process.java 1009 2012-02-09 09:16:13Z suman $";
...
// N
	...
	/** payrollprocesstype AD_Reference_ID=9000002 */
	public static final int PAYROLLPROCESSTYPE_AD_Reference_ID=9000002;
	/** General = General */
	public static final String PAYROLLPROCESSTYPE_General = "General";
	/** Mock = Mock */
	public static final String PAYROLLPROCESSTYPE_Mock = "Mock";
	/** Worksheet = Worksheet */
	public static final String PAYROLLPROCESSTYPE_Worksheet = "Worksheet";
	/** Set payrollprocesstype.
		@param payrollprocesstype payrollprocesstype	  */
	public void setpayrollprocesstype (String payrollprocesstype)
	{

		set_Value (COLUMNNAME_payrollprocesstype, payrollprocesstype);
	}

	/** Get payrollprocesstype.
		@return payrollprocesstype	  */
	public String getpayrollprocesstype () 
	{
		return (String)get_Value(COLUMNNAME_payrollprocesstype);
	}
