...
public static final String svnRevision =  "$Id: MPPOrder.java 1009 2012-02-09 09:16:13Z suman $";
	/**
	 * 
	 */
...
//	@Override
	...
	private void createMethodChangeVariance(MPPOrderBOMLine line)
	{
		...
		final BigDecimal qtyMethodChangeVariancePrev = line.getQtyVariance();	// Previous booked method Change  variance
		final BigDecimal qtyOpen = line.getQtyOpen();
