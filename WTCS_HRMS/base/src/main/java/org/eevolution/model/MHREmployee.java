...
public static final String svnRevision =  "$Id: MHREmployee.java 1009 2012-02-09 09:16:13Z suman $";
	@Override
	...
	/**
	 * Get the active business partner who is employee
	 * 
	 * @param ctx				: Context
	 ...
	 * @return					: 
	 */
	public static MHREmployee getActiveEmployee(Properties ctx, int businessPartnerId, String trxName){
		
		String whereClause = I_HR_Employee.COLUMNNAME_C_BPartner_ID + " = ?";
		
		return new Query(ctx, I_HR_Employee.Table_Name, whereClause, trxName)
				.setOnlyActiveRecords(true)
